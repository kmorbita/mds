			...
			<div class="panel-body">
				<form class="form-horizontal form-bordered" action="#">				<div class="col-md-12" align="left">
					...
					<div class="row">
						<div class="col-md-6">
							<div class="form-group">
								<label> REQUESTOR ADDRESS</label><b><span class="color-text" id="address_error"></span></b>
					...
					<div class="col-md-12">
						<div class="tabs">
							<ul class="nav nav-tabs nav-justified">
								...
								<li>
									<a href="#equipment" data-toggle="tab" class="text-center">Equipments</a>
								</li>
								<li>
												...
												<div class="form-group">
													<div class="col-md-12">
														...
														<div class="row">
															...
															<div class="col-md-4">
																<!-- <div class="form-group"> --><br>
																	<button class="btn btn-info btn-sm" type="button" id="edit_mp">ADD</button>
																	<!-- </div> -->
																</div>
															</div>
															<div class="form-group">
																	...
																	<tbody>
																		<?php foreach($reqmp as $row): ?>
																			<tr>
																				<td><?= $row['mp_name'] ?></td>
																				<td><?= $row['nos'] ?></td>
																				<td><button type="button" class="btn btn-danger btn-sm" onclick="del_mp('<?= $row['id'] ?>')"><i class="fa fa-trash-o"></i></button></td>
																			</tr>
																		<?php endforeach ?>
																	</tbody>
																</table>

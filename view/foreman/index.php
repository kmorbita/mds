<?php 
session_start();
if (isset($_SESSION['username']) && isset($_SESSION['password']) && isset($_SESSION['role']) && $_SESSION['role'] == "2") {
...
<head>
	...
	<link href="../../assets/datetime/css/bootstrap-datetimepicker.min.css" rel="stylesheet" media="screen">
	<!-- Head Libs -->
...
<body>
	<section class="body">
		...
		<header class="header">
			...
			<div class="header-right">
				...
				<input type="hidden" id="foreman_id" value="<?= $_SESSION['user_id'] ?>">
			...
			<section role="main" class="content-body">
				<header class="page-header">
					...
					<div class="right-wrapper pull-right">
						<ol class="breadcrumbs">
							...
							}else if (isset($_GET['page']) && $_GET['page'] == "working_jobs") {
								echo "<li><span>My Job List</span></li>";
							...
							}else if (isset($_GET['page']) && $_GET['page'] == "view_activity") {
								echo "<li><span>Job Order List</span></li>";
								echo "<li><span>View Job Activity</span></li>";
							}else if (isset($_GET['page']) && $_GET['page'] == "activity") {
								echo "<li><span>Job Order List</span></li>";
								echo "<li><span>Notify Timekeeper</span></li>";
							}else if (isset($_GET['page']) && $_GET['page'] == "personnel_activity") {
								echo "<li><span>Job Order List</span></li>";
								echo "<li><span>Personnel Activity<span></li>";
							}else if (isset($_GET['page']) && $_GET['page'] == "employee_assigned") {
				...
				<div class="row">
					<div class="col-md-12">
						...
						$joblist = $controller->joborderlist($_SESSION['id']);
	...
	<script type="text/javascript" src="../../assets/datetime/js/bootstrap-datetimepicker.js" charset="UTF-8"></script>
	<script type="text/javascript" src="../../assets/datetime/js/locales/bootstrap-datetimepicker.fr.js" charset="UTF-8"></script>
	<!-- Examples -->
	...
	<script type="text/javascript" src="js/notify_timekeep.js"></script>

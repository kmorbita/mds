...
$.ajax({
  ...
  success : function (res) {
    ...
    var html = "";
    arr.data_mp_req.forEach(function(item){
     html += "<tr class='mpadd_"+item.id+"'>";
     html += "<td>" + i + "<input type='hidden' id='nos_"+item.id+"' value='"+arr.nos+"'></td>"
     html += "<td>" + item.fname + " " + item.mname + " " + item.lname + "</td>"
     html += "<td>" + item.status + "<input type='hidden' id='mp_"+item.id+"' value='"+item.mp_id+"'></td>"

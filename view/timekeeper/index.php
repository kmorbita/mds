<?php 
session_start();
if (isset($_SESSION['username']) && isset($_SESSION['password']) && isset($_SESSION['role']) && $_SESSION['role'] == "3") {
...
<body>
			...
			<section role="main" class="content-body">
				<header class="page-header">
					...
					<div class="right-wrapper pull-right">
						<ol class="breadcrumbs">
							...
							if (isset($_GET['page']) && $_GET['page'] == "joborderlist") {
							...
							}else if(isset($_GET['page']) && $_GET['page'] == "edit_attendance"){
								echo "<li><span>Attendance</span></li>";
								echo "<li><span>Attendance List</span></li>";
								echo "<li><span>Edit Attendance</span></li>";
							}else if(isset($_GET['page']) && $_GET['page'] == "new_attendance"){
								echo "<li><span>Attendance</span></li>";
								echo "<li><span>Attendance List</span></li>";
								echo "<li><span>New Attendance</span></li>";
							}else if(isset($_GET['page']) && $_GET['page'] == "newdate_attendance"){
								echo "<li><span>Attendance</span></li>";
								echo "<li><span>Attendance List</span></li>";
								echo "<li><span>New Attendance</span></li>";
								echo "<li><span>Add new attendance</span></li>";
							...
							}else if(isset($_GET['page']) && $_GET['page'] == "view_attendance"){
								echo "<li><span>Attendance</span></li>";
								echo "<li><span>Attendance List</span></li>";
							}else if(isset($_GET['page']) && $_GET['page'] == "check_attendance"){
								echo "<li><span>Attendance</span></li>";
								echo "<li><span>Attendance List</span></li>";
								echo "<li><span>Set Date</span></li>";
								echo "<li><span>Check Attendance</span></li>";
							...
							}else if(isset($_GET['page']) && $_GET['page'] == "changepassword"){
								...
								echo "<li><span>Equipments</span></li>";
								echo "<li><span>Equipment List</span></li>";
							}else if (isset($_GET['page']) && $_GET['page'] == "operator") {
								echo "<li><span>Equipments</span></li>";
								echo "<li><span>Operator</span></li>";
							}else{
								echo "<li><span>Job Order List</span></li>";
							}
							?>
				...
				<div class="row">
					<div class="col-md-12">
						...
						$employees_present = $controller->employees_present();
						$equipment = $controller->equipment();
						$assigned_emp = $controller->assigned_emp();
						$messages = $controller->messages($_SESSION['role']);
						$add_new_attendance = $controller->add_new_attendance();
	...
	<script type="text/javascript" src="../../assets/vendor/bootstrap-fileupload/bootstrap-fileupload.min.js"></script>
	...
	<script type="text/javascript" src="js/equipment_optr.js"></script>

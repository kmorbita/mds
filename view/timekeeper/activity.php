...
if (isset($_GET['page']) && isset($_GET['activity_id']) != null) {
	...
	// $personnel_activity = $controller->personnel_activity($id);
	// $operator_activity = $controller->operator_activity($id);
...
<section class="panel">
	...
	<div class="panel-body">
		...
		</table><table class="table table-bordered table-striped mb-none" id="datatable-def2">									
			<thead>
				<tr>
					<th>Request No#</th>
					<th>Status</th>
...
<!-- 		<section class="panel">
			<header class="panel-heading">
				...
				<h2 class="panel-title">Personnel Activity & Tasks</h2>
			</header>
			<div class="panel-body"> -->
				<div class="col-md-12">

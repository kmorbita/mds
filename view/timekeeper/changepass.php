	...
	<div class="panel-body">
		...
		<div class="col-md-6">
			<div class="form-group">
				...
				<div class="col-md-1">
					<button type="button" onclick="pass_but()" class="btn btn-info btn-xs fa fa-eye"></button>
				</div>
			</div>
			<div class="form-group">
				<div class="col-md-4">
				...
				<div class="col-md-1">
					<button type="button" onclick="newpass_but()" class="btn btn-info btn-xs fa fa-eye"></button>
				</div>
			</div>
			<div class="form-group">
				<div class="col-md-4">
				...
				<div class="col-md-1">
					<button type="button" onclick="repass_but()" class="btn btn-info btn-xs fa fa-eye"></button>
				</div>
			</div>
			<div class="form-group">
				<div class="col-md-12" align="center">
					<button class="btn btn-info btn-sm" id="changepass">Change</button>
				</div>
			</div>
		</div>
		<div class="col-md-3"></div>

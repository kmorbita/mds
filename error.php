				...
				<div class="col-sm-4">
					...
					<ul class="nav nav-list primary">
						...
						if (isset($_SESSION['role']) == "1") {
							echo '<li><a href="view/supervisor/index.php"><i class="fa fa-caret-right text-dark"></i> Home</a></li>';
						}else if(isset($_SESSION['role']) == "2") {
							echo '<li><a href="view/foreman/index.php"><i class="fa fa-caret-right text-dark"></i> Home</a></li>';
						}else if(isset($_SESSION['role']) == "3"){
							echo '<li><a href="view/timekeeper/index.php"><i class="fa fa-caret-right text-dark"></i> Home</a></li>';
						}else if(isset($_SESSION['role']) == "4"){
							echo '<li><a href="view/joclerk/index.php"><i class="fa fa-caret-right text-dark"></i> Home</a></li>';
						}else if(isset($_SESSION['role']) == "5"){
							echo '<li><a href="view/superadmin/index.php"><i class="fa fa-caret-right text-dark"></i> Home</a></li>';
						}else{
